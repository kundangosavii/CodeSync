            ...
            <div className="text-gray-200 no-scrollbar">
                ...
                <div className="mt-3 rounded-xl border border-gray-800 bg-[#0f1020] p-4">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="mt-4 inline-flex items-center justify-center rounded-lg bg-orange-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
                    >
